package com.example.cardemo.presentation.screens.component
...
@Composable
fun CarRowItem(category: ProductItem, onItemClick: (ProductItem) -> Unit) {
...
fun UserDescription(category: ProductItem, modifier: Modifier) {
    Column(modifier = modifier) {
        ...
        Text("$${category.price}", fontSize = 14.sp, fontWeight = FontWeight.Bold)
        Spacer(Modifier.height(10.dp))
